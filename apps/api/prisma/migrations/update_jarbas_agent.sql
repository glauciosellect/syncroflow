-- Atualiza o agente Jarbas (conta nuclick10@gmail.com)
...
WHERE "workspaceId" IN (
  ...
  WHERE wm."userId" = 'cmpq3geah0005hx4v0ug37xs7'
);

-- 2. Apaga treinamentos existentes
...
-- 3. Apaga flows existentes (para não duplicar)
DELETE FROM "Flow"
WHERE "agentId" IN (
  SELECT a.id FROM "Agent" a
  WHERE a."workspaceId" IN (
